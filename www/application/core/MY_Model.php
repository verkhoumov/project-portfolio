...
class MY_Model extends CI_Model
{
	...
	protected $db_contacts           = 'contacts';
	protected $db_education          = 'education';
	protected $db_feedback           = 'feedback';
	protected $db_history            = 'history';
	protected $db_profile            = 'profile';
	protected $db_projects           = 'projects';
	protected $db_categories         = 'categories';
	protected $db_projects_skills    = 'projects_skills';
	protected $db_projects_tags      = 'projects_tags';
	protected $db_skills             = 'skills';
	protected $db_tags               = 'tags';
	protected $db_theses             = 'theses';
	protected $db_video              = 'video';
	protected $db_documents          = 'documents';
	protected $db_projects_documents = 'projects_documents';
